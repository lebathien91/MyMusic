  ...
  handlerEvents() {
    ...
    audio.ontimeupdate = function () {
      if (audio.duration && checkOnmouseAndTouch) {
        ...
        const timeMinutTotal = Math.floor(audio.duration / 60);
        let timeSecondTotal = Math.floor(audio.duration % 60);
        timeSecondTotal < 10
          ? (timeSecondTotal = `0${timeSecondTotal}`)
          : timeSecondTotal;
        timeTotal.innerText = `${timeMinutTotal}:${timeSecondTotal}`;
      }
    };
